#!/usr/bin/env python
# -*- coding: utf-8 -*-
u"""Official Evaluator for WikiTableQuestions datasets
...
def main():
    ...
    filename = "outputs/wikitableqa_final_results.jsonl"
